 ...
 */
public class LQRController<States extends Num, Inputs extends Num, Outputs extends Num> {
  ...
  public void latencyCompensate(
      StateSpaceSystem<States, Inputs, Outputs> plant, double dtSeconds, double inputDelaySeconds) {
